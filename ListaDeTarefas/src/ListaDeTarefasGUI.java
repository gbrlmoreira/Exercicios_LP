...
public class ListaDeTarefasGUI extends JFrame {
        ...
        botaoRemover.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (!tarefas.isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(ListaDeTarefasGUI.this, "Não há tarefas para remover.");
                }
            }
        });
    ...
    private void removerTarefa(String tarefa) {
        if (tarefas.contains(tarefa)) {
            ...
            System.out.println("Tarefa foi removida com sucesso");
        } else {
    ...
    private void listarTarefas() {
        ...
        JList<String> listaTarefas = new JList<>(tarefas.toArray(new String[0]));
        JScrollPane scrollPane = new JScrollPane(listaTarefas);
